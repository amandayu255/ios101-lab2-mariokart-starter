...
class ViewController: UIViewController,
  ...
  @IBAction func didTapMushroom(_ sender: UITapGestureRecognizer) {
    ...
    // ...
      let studentMiddleName: String? // Declaring our constant
      studentMiddleName = "Clark" // Assigning our constant
      print(studentMiddleName) // Optional("Clark")
      print(type(of: studentMiddleName)) // Optional<String>
